...
require("../../styles/partials/_radio.scss");
...
var Radio = function Radio(_ref) {
  var checked = _ref.checked,
      ...
      _ref$name = _ref.name,
      name = _ref$name === void 0 ? "names" : _ref$name,
      value = _ref.value,
  ...
  var handleClickLabel = (0, _react.useCallback)(function (e) {
  ...
  var handleCheckedClass = (0, _react.useCallback)(function (checked) {
    return function (e) {
      e.persist();
      console.log(e);
      var className = checked ? "radio--unchecked" : "radio--checked";
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: (0, _classnames["default"])("radio", checkedClass),
    type: "radio"
  }), /*#__PURE__*/_react["default"].createElement("div", {
    onAnimationEnd: handleAnimationEnd,
    className: "selection__box selection__box--radio",
    "aria-controls": "".concat(id, ",").concat(id, "__check")
  }, /*#__PURE__*/_react["default"].createElement("span", {
    id: "".concat(id, "__check"),
    role: "radio",
