    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _testUtils.userEvent.type(_testUtils.screen.getByLabelText("Test Label"), "invalid");
...
it('sets the number input to invalid when value is outside of range', function () {
  var _render = (0, _testUtils.render)( /*#__PURE__*/_react["default"].createElement(_["default"], {
    type: "number",
    handleChange: handleChange,
    label: "Test Label",
    value: "0",
